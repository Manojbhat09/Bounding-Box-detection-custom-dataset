...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='weights/valve_detect.onnx')
    args = parser.parse_args()
    onnx_file_path = args.model_path
    print("onnx_file_path ", onnx_file_path)
    engine_file_path = onnx_file_path.split("/")[-1].split(".")[-2]+".trt"
    print("Engine name ", engine_file_path)
