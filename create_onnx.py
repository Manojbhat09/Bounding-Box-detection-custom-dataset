...
def arg_parse(): 
	...
	parser.add_argument("--cfg", dest = 'cfgfile', help = "Config file",
						default = "cfg/yolov3-tiny.cfg", type = str)  ## yolov3.cfg  yolov3.weights  ## yolov3_cls_1.cfg 
	parser.add_argument("--weights", dest = 'weightsfile', help = "weightsfile",
						default = "weights/valve_detect.pt", type = str)  ## yolov3_cls_1_200.weights   ## yolov3_cls_1_final.weights
